...
swiftc -emit-library -swift-version 5 -O -target arm64-apple-macosx15.0 -module-cache-path native/.build/module-cache -import-objc-header native/NodeBridge.h native/RecorderGlass.swift -o native/.build/recorder-glass.node -framework AppKit -Xlinker -undefined -Xlinker dynamic_lookup
